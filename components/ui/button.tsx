...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 rounded-xl uppercase tracking-wide",
  {
    variants: {
      variant: {
        default:
        ...
        ghost:
          "bg-transparent te xt-slate-500 hover:bg-slate-100 border-transprent border-0",
        sidebar:
